...
<div>
    ...
    <el-form :inline="true" :model="formSearch" class="list-form-pv" :style='{"border":"1px solid #C7C7C7","padding":"20px 10px 0","margin":"0 0 20px","alignItems":"center","background":"#fff","flexDirection":"row","display":"flex","width":"100%","height":"auto","order":"1"}'>
      <el-form-item :style='{"flexWrap":"wrap","margin":"0 0 20px","display":"flex"}'>
	    <div class="lable" v-if="true" :style='{"width":"auto","padding":"0 5px 0","lineHeight":"42px","textAlign":"right","display":"inline-block"}'>歌手姓名：</div>
        <el-input v-model="formSearch.geshouxingming" placeholder="歌手姓名" @keydown.enter.native="getList(1, curFenlei)" clearable></el-input>
      </el-form-item>
      <el-form-item :style='{"flexWrap":"wrap","margin":"0 0 20px","display":"flex"}'>
	    <div class="lable" v-if="true" :style='{"width":"auto","padding":"0 5px 0","lineHeight":"42px","textAlign":"right","display":"inline-block"}'>标签：</div>
        <el-input v-model="formSearch.biaoqian" placeholder="标签" @keydown.enter.native="getList(1, curFenlei)" clearable></el-input>
      </el-form-item>
      <el-form-item :style='{"flexWrap":"wrap","margin":"0 0 20px","display":"flex"}'>
	    <div class="lable" v-if="true" :style='{"width":"auto","padding":"0 5px 0","lineHeight":"42px","textAlign":"right","display":"inline-block"}'>成名歌曲：</div>
        <el-input v-model="formSearch.chengminggequ" placeholder="成名歌曲" @keydown.enter.native="getList(1, curFenlei)" clearable></el-input>
      </el-form-item>
	  ...
	  <el-button v-if="btnAuth('geshouxinxi','新增')" :style='{"cursor":"pointer","border":"0","padding":"0px 15px","margin":"0 0 20px","outline":"none","color":"#fff","borderRadius":"0px","background":"#75664d","width":"auto","fontSize":"14px","lineHeight":"40px","height":"40px"}' type="primary" @click="add('/index/geshouxinxiAdd')"><i v-if="true" :style='{"color":"#fff","margin":"0 10px 0 0","fontSize":"14px"}' class="el-icon-circle-plus-outline"></i>添加</el-button>
    </el-form>
	...
	<div class="list" :style='{"border":"1px solid #C7C7C7","width":"auto","margin":"0","background":"#fff","flex":"1","order":"3"}'>
		...
		<div class="list1 index-pv1" :style='{"width":"100%","padding":"20px 10px 0","background":"#fff","height":"auto"}'>
			<div :style='{"border":"1px solid #E0E0E0","padding":"8px","margin":"0 1% 20px","background":"#ffff","display":"inline-block","width":"23%","position":"relative","height":"auto"}' v-for="(item, index) in dataList" :key="index" @click.stop="toDetail(item)" class="list-item animation-box">
				...
				<div :style='{"padding":"0 10px","lineHeight":"1.5","fontSize":"14px","color":"#000","textAlign":"center"}' class="name ">{{item.geshouxingming}}</div>
				<div :style='{"padding":"0 10px","lineHeight":"1.5","fontSize":"14px","color":"#000","textAlign":"center"}' class="name ">{{item.geshouxingbie}}</div>
  ...
  export default {
    ...
    methods: {
      ...
      getList(page, fenlei, ref = '') {
        ...
        this.$http.get(`geshouxinxi/${this.centerType?'page':'list'}`, {params: Object.assign(params, searchWhere)}).then(res => {
          if (res.data.code == 0) {
      ...
      toDetail(item) {
        ...
        this.$router.push({path: '/index/geshouxinxiDetail', query: params});
      },
