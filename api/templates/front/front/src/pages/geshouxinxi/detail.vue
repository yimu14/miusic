...
<div>
	<div :style='{"padding":"20px","boxShadow":"0px 4px 10px 0px rgba(0,0,0,0.1)","margin":"0px auto","borderColor":"#75664D","background":"#fff","borderWidth":"5px 0 0 0","width":"80%","borderStyle":"solid"}' class="breadcrumb-preview">
		<el-breadcrumb :separator="'>'" :style='{"fontSize":"14px","lineHeight":"1","justifyContent":"center","display":"flex"}'>
			...
			<el-breadcrumb-item class="item2" v-for="(item, index) in breadcrumbItem" :key="index" to="/index/geshouxinxi"><a>{{item.name}}</a></el-breadcrumb-item>
		...
		<div class="attr" :style='{"borderColor":"#75664d","margin":"10px 2%","background":"#fff","flex":"1","borderWidth":"5px 0 0","display":"flex","width":"45%","position":"relative","borderStyle":"solid","order":"1"}'>
			...
			<div class="info" :style='{"background":"#fff","flex":"1"}'>
				...
				<div class="item" :style='{"padding":"5px 10px","boxShadow":"0 1px 0 #D8D8D8","justifyContent":"spaceBetween","display":"flex"}'>
					<div class="lable" :style='{"padding":"0 10px","color":"#999","textAlign":"left","width":"auto","fontSize":"14px","lineHeight":"40px","height":"40px"}'>歌手性别</div>
					<div  :style='{"padding":"8px 10px 0","fontSize":"14px","lineHeight":"24px","color":"#666","flex":"1","height":"auto"}'>{{detail.geshouxingbie}}</div>
				</div>
				<div class="item" :style='{"padding":"5px 10px","boxShadow":"0 1px 0 #D8D8D8","justifyContent":"spaceBetween","display":"flex"}'>
					<div class="lable" :style='{"padding":"0 10px","color":"#999","textAlign":"left","width":"auto","fontSize":"14px","lineHeight":"40px","height":"40px"}'>流派</div>
					<div  :style='{"padding":"8px 10px 0","fontSize":"14px","lineHeight":"24px","color":"#666","flex":"1","height":"auto"}'>{{detail.liupai}}</div>
				</div>
				<div class="item" :style='{"padding":"5px 10px","boxShadow":"0 1px 0 #D8D8D8","justifyContent":"spaceBetween","display":"flex"}'>
					<div class="lable" :style='{"padding":"0 10px","color":"#999","textAlign":"left","width":"auto","fontSize":"14px","lineHeight":"40px","height":"40px"}'>标签</div>
					<div  :style='{"padding":"8px 10px 0","fontSize":"14px","lineHeight":"24px","color":"#666","flex":"1","height":"auto"}'>{{detail.biaoqian}}</div>
				</div>
				<div class="item" :style='{"padding":"5px 10px","boxShadow":"0 1px 0 #D8D8D8","justifyContent":"spaceBetween","display":"flex"}'>
					<div class="lable" :style='{"padding":"0 10px","color":"#999","textAlign":"left","width":"auto","fontSize":"14px","lineHeight":"40px","height":"40px"}'>出道日期</div>
					<div  :style='{"padding":"8px 10px 0","fontSize":"14px","lineHeight":"24px","color":"#666","flex":"1","height":"auto"}'>{{detail.chudaoriqi}}</div>
				</div>
				<div class="item" :style='{"padding":"5px 10px","boxShadow":"0 1px 0 #D8D8D8","justifyContent":"spaceBetween","display":"flex"}'>
					<div class="lable" :style='{"padding":"0 10px","color":"#999","textAlign":"left","width":"auto","fontSize":"14px","lineHeight":"40px","height":"40px"}'>成名歌曲</div>
					<div  :style='{"padding":"8px 10px 0","fontSize":"14px","lineHeight":"24px","color":"#666","flex":"1","height":"auto"}'>{{detail.chengminggequ}}</div>
				</div>
				<div class="item" :style='{"padding":"5px 10px","boxShadow":"0 1px 0 #D8D8D8","justifyContent":"spaceBetween","display":"flex"}'>
					<div class="lable" :style='{"padding":"0 10px","color":"#999","textAlign":"left","width":"auto","fontSize":"14px","lineHeight":"40px","height":"40px"}'>热门歌曲</div>
					<div  :style='{"padding":"8px 10px 0","fontSize":"14px","lineHeight":"24px","color":"#666","flex":"1","height":"auto"}'>{{detail.remengequ}}</div>
				</div>
				<div class="item" :style='{"padding":"5px 10px","boxShadow":"0 1px 0 #D8D8D8","justifyContent":"spaceBetween","display":"flex"}'>
					<div class="lable" :style='{"padding":"0 10px","color":"#999","textAlign":"left","width":"auto","fontSize":"14px","lineHeight":"40px","height":"40px"}'>专辑介绍</div>
					<div  :style='{"padding":"8px 10px 0","fontSize":"14px","lineHeight":"24px","color":"#666","flex":"1","height":"auto"}'>{{detail.zhuanjijieshao}}</div>
				</div>
				<div class="btn" :style='{"padding":"10px 0","flexWrap":"wrap","display":"flex"}'>
					<el-button :style='{"border":"0","cursor":"pointer","padding":"0 10px","margin":"0 5px 0 0","outline":"none","color":"#fff","borderRadius":"4px","background":"#75664d","width":"auto","lineHeight":"40px","fontSize":"14px","height":"40px"}' v-if="btnAuth('geshouxinxi','修改')" @click="editClick">修改</el-button>
					<el-button :style='{"border":"0","cursor":"pointer","padding":"0 10px","margin":"0 5px 0 0","outline":"none","color":"#fff","borderRadius":"4px","background":"#75664d","width":"auto","lineHeight":"40px","fontSize":"14px","height":"40px"}' v-if="btnAuth('geshouxinxi','删除')" @click="delClick">删除</el-button>
					<el-button :style='{"border":"0","cursor":"pointer","padding":"0 10px","margin":"0 5px 0 0","outline":"none","color":"#fff","borderRadius":"4px","background":"#75664d","width":"auto","lineHeight":"40px","fontSize":"14px","height":"40px"}' v-if="btnAuth('geshouxinxi','私聊')&&detail.id!=mid" @click="chatClick">联系TA</el-button>
				</div>
			</div>
		</div>
  ...
  export default {
    ...
    methods: {
      ...
      storeup(type) {
        ...
        if (type == -1 && this.isStoreup) {
          this.$http.get('storeup/list', {params: {page: 1, limit: 1, type: 1, refid: this.detail.id, tablename: 'geshouxinxi', userid: localStorage.getItem('frontUserid')}}).then(res => {
    ...
    getThumbsupOrCrazilyStatus() {
        if(localStorage.getItem("frontToken")) {
            this.$http.get('storeup/list', {params: {page: 1, limit: 1, type: 21, refid: this.detail.id, tablename: 'geshouxinxi', userid: localStorage.getItem('frontUserid')}}).then(res => {
              if (res.data.code == 0 && res.data.data.list.length > 0) {
            ...
            this.$http.get('storeup/list', {params: {page: 1, limit: 1, type: 22, refid: this.detail.id, tablename: 'geshouxinxi', userid: localStorage.getItem('frontUserid')}}).then(res => {
              if (res.data.code == 0 && res.data.data.list.length > 0) {
      ...
      sizeChange(size){
		...
		backClick(){
			...
			this.$router.push({path: '/index/geshouxinxi', query: params});
		},
		// 下载
		download(file){
			if(!file) {
	  ...
	  discussDel(id){
		  this.$confirm('是否删除此评论？')
		    .then(_ => {
		      this.$http.post('discussgeshouxinxi/delete',[id]).then(res=>{
	  ...
	  addDiscussNum(type){
		...
		// 修改
		editClick(){
			this.$router.push(`/index/geshouxinxiAdd?type=edit&&id=${this.detail.id}`);
		},
		// 删除
		async delClick(){
			await this.$confirm('是否删除此歌手信息？')
			  .then(_ => {
			    this.$http.post('geshouxinxi/delete', [this.detail.id]).then(async res => {
					if (res.data.code == 0) {
