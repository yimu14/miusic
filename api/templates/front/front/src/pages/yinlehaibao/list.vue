...
<div>
    ...
    <el-form :inline="true" :model="formSearch" class="list-form-pv" :style='{"border":"1px solid #C7C7C7","padding":"20px 10px 0","margin":"0 0 20px","alignItems":"center","background":"#fff","flexDirection":"row","display":"flex","width":"100%","height":"auto","order":"1"}'>
      <el-form-item :style='{"flexWrap":"wrap","margin":"0 0 20px","display":"flex"}'>
	    <div class="lable" v-if="true" :style='{"width":"auto","padding":"0 5px 0","lineHeight":"42px","textAlign":"right","display":"inline-block"}'>歌曲名称：</div>
        <el-input v-model="formSearch.gequmingcheng" placeholder="歌曲名称" @keydown.enter.native="getList(1, curFenlei)" clearable></el-input>
      </el-form-item>
      <el-form-item :style='{"flexWrap":"wrap","margin":"0 0 20px","display":"flex"}'>
	    <div class="lable" v-if="true" :style='{"width":"auto","padding":"0 5px 0","lineHeight":"42px","textAlign":"right","display":"inline-block"}'>歌手：</div>
        <el-input v-model="formSearch.geshou" placeholder="歌手" @keydown.enter.native="getList(1, curFenlei)" clearable></el-input>
      </el-form-item>
      <el-form-item :style='{"flexWrap":"wrap","margin":"0 0 20px","display":"flex"}'>
	    <div class="lable" v-if="true" :style='{"width":"auto","padding":"0 5px 0","lineHeight":"42px","textAlign":"right","display":"inline-block"}'>专辑名称：</div>
	...
	<div class="list" :style='{"border":"1px solid #C7C7C7","width":"auto","margin":"0","background":"#fff","flex":"1","order":"3"}'>
		...
		<div class="list1 index-pv1" :style='{"width":"100%","padding":"20px 10px 0","background":"#fff","height":"auto"}'>
			<div :style='{"border":"1px solid #E0E0E0","padding":"8px","margin":"0 1% 20px","background":"#ffff","display":"inline-block","width":"23%","position":"relative","height":"auto"}' v-for="(item, index) in dataList" :key="index" @click.stop="toDetail(item)" class="list-item animation-box">
				...
				<div :style='{"padding":"0 10px","lineHeight":"1.5","fontSize":"14px","color":"#000","textAlign":"center"}' class="name ">{{item.gequmingcheng}}</div>
				<div :style='{"padding":"0 10px","lineHeight":"1.5","fontSize":"14px","color":"#000","textAlign":"center"}' class="name ">{{item.geshou}}</div>
				<div :style='{"padding":"0 10px","lineHeight":"1.5","fontSize":"14px","color":"#000","textAlign":"center"}' class="name ">{{item.xiaichengdu}}</div>
  ...
  export default {
    ...
    methods: {
      ...
      getList(page, fenlei, ref = '') {
        ...
        this.$http.get(`yinlehaibao/${this.centerType?'page':'list'}`, {params: Object.assign(params, searchWhere)}).then(res => {
          if (res.data.code == 0) {
      ...
      toDetail(item) {
        ...
        this.$router.push({path: '/index/yinlehaibaoDetail', query: params});
      },
