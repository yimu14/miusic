...
<div>
	<div :style='{"padding":"20px","boxShadow":"0px 4px 10px 0px rgba(0,0,0,0.1)","margin":"0px auto","borderColor":"#75664D","background":"#fff","borderWidth":"5px 0 0 0","width":"80%","borderStyle":"solid"}' class="breadcrumb-preview">
		<el-breadcrumb :separator="'>'" :style='{"fontSize":"14px","lineHeight":"1","justifyContent":"center","display":"flex"}'>
			...
			<el-breadcrumb-item class="item2" v-for="(item, index) in breadcrumbItem" :key="index" to="/index/remenyinle"><a>{{item.name}}</a></el-breadcrumb-item>
	...
	<div class="detail-preview" :style='{"padding":"0 10% 20px","margin":"20px auto","flexWrap":"wrap","display":"flex","width":"100%","position":"relative","justifyContent":"space-between"}'>
		<div class="attr" :style='{"borderColor":"#75664d","margin":"10px 2%","background":"#fff","flex":"1","borderWidth":"5px 0 0","display":"flex","width":"45%","position":"relative","borderStyle":"solid","order":"1"}'>
			...
			<div class="info" :style='{"background":"#fff","flex":"1"}'>
				...
				<div class="item" :style='{"padding":"5px 10px","boxShadow":"0 1px 0 #D8D8D8","justifyContent":"spaceBetween","display":"flex"}'>
					<div class="lable" :style='{"padding":"0 10px","color":"#999","textAlign":"left","width":"auto","fontSize":"14px","lineHeight":"40px","height":"40px"}'>语言</div>
					<div  :style='{"padding":"8px 10px 0","fontSize":"14px","lineHeight":"24px","color":"#666","flex":"1","height":"auto"}'>{{detail.yuyan}}</div>
				</div>
				<div class="item" :style='{"padding":"5px 10px","boxShadow":"0 1px 0 #D8D8D8","justifyContent":"spaceBetween","display":"flex"}'>
					<div class="lable" :style='{"padding":"0 10px","color":"#999","textAlign":"left","width":"auto","fontSize":"14px","lineHeight":"40px","height":"40px"}'>专辑</div>
					<div  :style='{"padding":"8px 10px 0","fontSize":"14px","lineHeight":"24px","color":"#666","flex":"1","height":"auto"}'>{{detail.zhuanji}}</div>
				</div>
				<div class="item" :style='{"padding":"5px 10px","boxShadow":"0 1px 0 #D8D8D8","justifyContent":"spaceBetween","display":"flex"}'>
					<div class="lable" :style='{"padding":"0 10px","color":"#999","textAlign":"left","width":"auto","fontSize":"14px","lineHeight":"40px","height":"40px"}'>时长</div>
					<div  :style='{"padding":"8px 10px 0","fontSize":"14px","lineHeight":"24px","color":"#666","flex":"1","height":"auto"}'>{{detail.shizhang}}</div>
				</div>
				<div class="item" :style='{"padding":"5px 10px","boxShadow":"0 1px 0 #D8D8D8","justifyContent":"spaceBetween","display":"flex"}'>
					<div class="lable" :style='{"padding":"0 10px","color":"#999","textAlign":"left","width":"auto","fontSize":"14px","lineHeight":"40px","height":"40px"}'>发行方</div>
					<div  :style='{"padding":"8px 10px 0","fontSize":"14px","lineHeight":"24px","color":"#666","flex":"1","height":"auto"}'>{{detail.faxingfang}}</div>
				</div>
				<div class="item" :style='{"padding":"5px 10px","boxShadow":"0 1px 0 #D8D8D8","justifyContent":"spaceBetween","display":"flex"}'>
					<div class="lable" :style='{"padding":"0 10px","color":"#999","textAlign":"left","width":"auto","fontSize":"14px","lineHeight":"40px","height":"40px"}'>歌词</div>
					<div  :style='{"padding":"8px 10px 0","fontSize":"14px","lineHeight":"24px","color":"#666","flex":"1","height":"auto"}'>{{detail.geci}}</div>
				</div>
				<div class="item" :style='{"padding":"5px 10px","boxShadow":"0 1px 0 #D8D8D8","justifyContent":"spaceBetween","display":"flex"}'>
					<div class="lable" :style='{"padding":"0 10px","color":"#999","textAlign":"left","width":"auto","fontSize":"14px","lineHeight":"40px","height":"40px"}'>歌名</div>
					<div  :style='{"padding":"8px 10px 0","fontSize":"14px","lineHeight":"24px","color":"#666","flex":"1","height":"auto"}'>{{detail.songname}}</div>
				</div>
				<div class="item" :style='{"padding":"5px 10px","boxShadow":"0 1px 0 #D8D8D8","justifyContent":"spaceBetween","display":"flex"}'>
					<div class="lable" :style='{"padding":"0 10px","color":"#999","textAlign":"left","width":"auto","fontSize":"14px","lineHeight":"40px","height":"40px"}'>歌手</div>
				...
				<div class="item" :style='{"padding":"5px 10px","boxShadow":"0 1px 0 #D8D8D8","justifyContent":"spaceBetween","display":"flex"}'>
					<div class="lable" :style='{"padding":"0 10px","color":"#999","textAlign":"left","width":"auto","fontSize":"14px","lineHeight":"40px","height":"40px"}'>音乐文件</div>
					<audio :style='{"height":"40px"}' :src="baseUrl + detail.songfile" controls="controls">
						您的浏览器不支持音频播放
					</audio>
				</div>
				<div class="btn" :style='{"padding":"10px 0","flexWrap":"wrap","display":"flex"}'>
					<el-button :style='{"border":"0","cursor":"pointer","padding":"0 10px","margin":"0 5px 0 0","outline":"none","color":"#fff","borderRadius":"4px","background":"#75664d","width":"auto","lineHeight":"40px","fontSize":"14px","height":"40px"}' v-if="btnAuth('remenyinle','修改')" @click="editClick">修改</el-button>
					<el-button :style='{"border":"0","cursor":"pointer","padding":"0 10px","margin":"0 5px 0 0","outline":"none","color":"#fff","borderRadius":"4px","background":"#75664d","width":"auto","lineHeight":"40px","fontSize":"14px","height":"40px"}' v-if="btnAuth('remenyinle','删除')" @click="delClick">删除</el-button>
					<el-button :style='{"border":"0","cursor":"pointer","padding":"0 10px","margin":"0 5px 0 0","outline":"none","color":"#fff","borderRadius":"4px","background":"#75664d","width":"auto","lineHeight":"40px","fontSize":"14px","height":"40px"}' v-if="btnAuth('remenyinle','私聊')&&detail.id!=mid" @click="chatClick">联系TA</el-button>
				</div>
			</div>
		</div>
		...
		<el-tabs class="detail" :style='{"border":"1px solid #DCDFE6","width":"100%","boxShadow":"0 1px 6px 0 rgba(0, 0, 0, .1)","background":"#FFF","order":"4"}' v-model="activeName" type="border-card">
			<el-tab-pane label="歌曲简介" name="first">
  ...
  export default {
    ...
    methods: {
          ...
          this.$http.get(this.tablename + '/detail/'  + this.id, {}).then(res => {
            if (res.data.code == 0) {
              this.detail = res.data.data;
				this.title = this.detail.yinlefenlei;
      ...
      storeup(type) {
        if (type == 1 && !this.isStoreup) {
          ...
          this.$http.post('storeup/add', this.storeupParams).then(res => {
            if (res.data.code == 0) {
			  ...
			  this.$http.post('remenyinle/update', this.detail).then(res => {});
              this.$message({
                type: 'success',
                message: '收藏成功!',
                duration: 1500,
        ...
        if (type == -1 && this.isStoreup) {
          this.$http.get('storeup/list', {params: {page: 1, limit: 1, type: 1, refid: this.detail.id, tablename: 'remenyinle', userid: localStorage.getItem('frontUserid')}}).then(res => {
      ...
      sizeChange(size){
		...
		backClick(){
			...
			this.$router.push({path: '/index/remenyinle', query: params});
		},
		// 下载
		download(file){
			if(!file) {
      ...
      getDiscussList(page) {
        this.$http.get('discussremenyinle/list', {params: {page, limit: this.pageSize, refid: this.detail.id}}).then(res => {
          if (res.data.code == 0) {
	  ...
	  discussDel(id){
		  this.$confirm('是否删除此评论？')
		    .then(_ => {
		      this.$http.post('discussremenyinle/delete',[id]).then(res=>{
      ...
      submitForm(formName) {
        this.$refs[formName].validate((valid) => {
          if (valid) {
            ...
            this.$http.post('discussremenyinle/add', this.form).then(res => {
              if (res.data.code == 0) {
                this.form.content = '';
	  ...
	  addDiscussNum(type){
		...
		// 修改
		editClick(){
			this.$router.push(`/index/remenyinleAdd?type=edit&&id=${this.detail.id}`);
		},
		// 删除
		async delClick(){
			await this.$confirm('是否删除此热门音乐？')
			  .then(_ => {
			    this.$http.post('remenyinle/delete', [this.detail.id]).then(async res => {
					if (res.data.code == 0) {
