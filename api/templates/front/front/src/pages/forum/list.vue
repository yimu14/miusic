<template>
<div class="forum-preview" :style='{"width":"100%","padding":"20px 10%","margin":"20px auto","position":"relative","background":"#fff"}'>
    <div :style='{"width":"100%"}'>
		<div :style='{"padding":"0 10px","color":"#75664D","textAlign":"center","width":"100%","lineHeight":"54px","fontSize":"24px","height":"54px"}'>音乐论坛</div>
	</div>
    <el-form :style='{"padding":"10px","margin":"10px 0","alignItems":"center","background":"#75664D","display":"flex","width":"100%","height":"auto"}' :inline="true" :model="formSearch" class="list-form-pv">
		<el-form-item :style='{"width":"100%","margin":"0 10px"}'>
			<el-input v-model="title" placeholder="标题"></el-input>
		</el-form-item>
		<div :style='{"display":"flex"}'>
			<el-button class="searchBtn" type="primary" @click="getForumList(1)">
				<span class="icon iconfont icon-shouye-zhihui" :style='{"color":"#75664D","margin":"0 10px 0 0","fontSize":"14px"}'></span>
				查询
			</el-button>
	...
	<div class="z-box" :style='{"width":"100%","padding":"0px"}'>
		<div class="section-content" v-for="item in forumList" :key="item.id" @click="toForumDetail(item)">
		  <div :style='{"width":"100%","margin":"5px","fontSize":"14px","color":"#333"}' class="item-style">{{item.title}}</div>
		  <div :style='{"color":"#333","padding":"0 10px","fontSize":"14px"}' class="item-style">发布人：{{item.username}}</div>
		  <div :style='{"fontSize":"14px","color":"#333","textAlign":"right","flex":"1"}' class="item-style">{{item.addtime}}</div>
		</div>
	</div>
