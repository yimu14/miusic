		...
		>
			<template >
				...
				<el-form-item :style='{"width":"49%","margin":"0 0 20px 0"}' v-else-if="ruleForm.url" label="url" prop="url">
					<span :style='{"border":"1px solid rgba(0,0,0,0.3)","padding":"0 10px","boxShadow":"0 0 6px rgba(0,0,0,0.3)","borderRadius":"4px","color":"#333","background":"#fff","display":"inline-block","fontSize":"14px","lineHeight":"40px","fontWeight":"500"}'>{{ruleForm.url}}</span>
				</el-form-item>
