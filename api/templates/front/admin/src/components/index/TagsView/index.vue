<template>
	<div id="tags-view-container" class="tags-view-container" :style='{"padding":"4px 30px","margin":"0","borderColor":"#000","background":"rgba(0,0,0,0.5)","borderWidth":"0 0 1px","width":"calc(100% - 0px)","borderStyle":"solid","height":"34px"}'>
